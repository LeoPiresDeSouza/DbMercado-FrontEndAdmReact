...
function ProdutoNovoPage(): React.ReactElement {
  ...
  const handleSubmit = useCallback(
    ...
    [addNotification, navigate, t, values]
  );
      ...
      <div className="mx-auto w-full max-w-5xl">
        <div className="mb-8 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h1 className="text-2xl font-bold text-white">{t('modules.productsAdmin.formTitleNew')}</h1>
        ...
        <form onSubmit={(e) => void handleSubmit(e)} className="flex flex-col">
          <div className="sticky top-0 z-10 mb-6 flex flex-col gap-4 rounded-xl border border-[#2D3748] bg-[rgba(20,27,45,0.95)] px-6 py-4 shadow-md backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between">
            <h2 className="text-lg font-semibold text-white">{t('modules.productsAdmin.formTitleNew')}</h2>
...
export default ProdutoNovoPage;
